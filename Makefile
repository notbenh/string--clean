# This Makefile is for the String::Clean extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/String/Clean.pm]
#     AUTHOR => q[ben hengst <notbenh@CPAN.org>]
#     NAME => q[String::Clean]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], YAML=>q[0], Carp::Assert::More=>q[0] }
#     VERSION_FROM => q[lib/String/Clean.pm]
#     clean => { FILES=>q[String-Clean-*] }
...
MAKE = make
FULLEXT = String/Clean
BASEEXT = Clean
PARENT_NAME = String
DLBASE = $(BASEEXT)
VERSION_FROM = lib/String/Clean.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/String/Clean.pm

PM_TO_BLIB = lib/String/Clean.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/String/Clean.pm $(INST_MAN3DIR)/String::Clean.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                String-Clean' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            use data objects to clean strings' >> META_new.yml
	$(NOECHO) $(ECHO) 'license:             ~' >> META_new.yml
	$(NOECHO) $(ECHO) 'generated_by:        ExtUtils::MakeMaker version 6.36' >> META_new.yml
	$(NOECHO) $(ECHO) 'distribution_type:   module' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:     ' >> META_new.yml
	$(NOECHO) $(ECHO) '    Carp::Assert::More:            0' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    - ben hengst <notbenh@CPAN.org>' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>use data objects to clean strings</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>ben hengst &lt;notbenh@CPAN.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Carp-Assert-More" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/String/Clean.pm blib/lib/String/Clean.pm 
